...
def victoria(inventario):
    ...
    print("Que es eso?...")
    print(
        "Parece que alguien ha metido en tu mochila una llave y un papel con un 5 escrito sobre el. ")  # El numero es susceptible a cambios
...
def combate(inventario, stats_player, enemigo_selec, habilidad, bolsas):  # Esta funcion comprueba que combate debe activar
    ...
    if enemigo == 0:
        ...
        cueva_goblins.combate_goblin(stats_player, habilidad, inventario, bolsas)
...
def combate_estafermo(inventario, stats_player):
    ...
    while Combate == True:
        ...
        while turno_player == True:  # Bucle que representa el turno del jugador
            print("Has impactado")
            dam_player = (stats_player.get("fuerza") - 10) + dados(
        ...
        while turno_enemigo == True:
            ...
            impacto_player = 12 + (stats_player.get(
                "destreza") - 10)  # Deberemos calcular cuanto debe sacar el enemigo para impactar al jugador, esto en base a la estadistica de destreza
            ...
            if golpe_estafermo >= impacto_player:  # El enemigo golpea al jugador
                ...
                print(
                    f"El Estafermo te ha hecho {dam_estafermo} punto de daño tienes, {vida_player} puntos de vida")  # Imprimimos detalles del combate como el daño y nuestra vida
        ...
        while turno_enemigo == True:
            ...
            if golpe_rata >= impacto_player:  # El enemigo golpea al jugador
                ...
                stats_player.update(
                    {"vida": vida_player})  # Subimos, por asñi decirlo, el nuevo valor al diccionario del jugador
                print(
                    f"La rata te ha hecho {dam_rata} punto de daño tienes, {vida_player} puntos de vida")  # Imprimimos detalles del combate como el daño y nuestra vida
                turno_player, turno_enemigo = True, False  # Se activan y desactivan los turnos homogeneamente
            else:  # El estafermo no ha impactado
        ...
        while turno_enemigo == True:
            ...
            if golpe_ogro >= impacto_player:
                ...
                stats_player.update(
                    {"vida": vida_player})  # Subimos, por asñi decirlo, el nuevo valor al diccionario del jugador
                print(
                    f"El Ogro te ha hecho {dam_ogro} punto de daño tienes, {vida_player} puntos de vida")  # Imprimimos detalles del combate como el daño y nuestra vida
