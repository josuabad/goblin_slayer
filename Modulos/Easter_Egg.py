...
if localizacion == 5:
    ...
    EasterEgg(inventario,stats_player,easterEgg)
else:
    print("Vale vas a ir a esa ubicacion.")
"""

"""a = inventario.get("arma")
print(a)
print(inventario)
inventario.update({"arma":inventario.get("arma") | {"Espada ignea":5}}) #Esta solucion es de GENIO ;), el operador '|' fusiona 2 diccionario 
