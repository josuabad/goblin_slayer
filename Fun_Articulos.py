...
def arma(tipo):
    if tipo.lower() == 'espada':
        precio_espada = 10
        return {'espada': {'daño': 8, 'precio': precio_espada, 'venta': precio_espada * 0.5, 'manos': 1, 'arma': True}}
        ...
        return {'puños': {'daño': 4, 'manos': 2, 'arma': True}}
    else:
        pass
...
def proteccion(tipo):
    if tipo.lower() == 'escudo':
        precio_escudo = 10
        return {'escudo': {'precio': precio_escudo, 'venta': precio_escudo * 0.5, 'destreza': 1, 'protección': True}}
