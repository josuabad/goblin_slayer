...
from lib import config_habilidad
...
run = True
while run:
    set_habilidades = config_habilidad.habilidades(personaje_habilidades, puntos_habilidades)
    puntos_habilidades = set_habilidades[1]  # Actualización de los puntos de habilidad restantes
    set_personaje = config_habilidad.especificas_personaje(personaje_habilidades, personaje)
