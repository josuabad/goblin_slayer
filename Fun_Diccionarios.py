...
def intercambiar(diccionario_emisor, from_key, atributo, valor_de_cambio,
                 diccionario_receptor):  # La función cambia valores (True), pero también puede modificarlos de un diccionario a otro (False)(Ejemplo: de mochila a inventario)
    # Explicación:
