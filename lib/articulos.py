...
def arma(tipo):
    ...
    elif tipo.lower() == 'espada magica':
        precio_espada_magica = 200
        return {'espada magica': {'daño': 6, 'precio': precio_espada_magica, 'venta': precio_espada_magica * 0.5, 'manos': 1, 'arma': True}}
...
def proteccion(tipo):
    if tipo.lower() == 'escudo':
        precio = 10
        return {'escudo': {'precio': precio, 'venta': precio * 0.5, 'destreza': 1, 'proteccion': True, 'cantidad': 1}}
    elif tipo.lower() == 'escudo goblin':
        return {'escudo goblin': {'precio': None, 'venta': 5, 'destreza': 1, 'proteccion': True, 'cantidad': 1}}
    elif tipo.lower() == 'armadura nivel 1':
        precio_arm_uno = 30
        return {'escudo goblin': {'precio': precio_arm_uno, 'venta': precio_arm_uno * 0.5, 'destreza': 2, 'proteccion': True, 'cantidad': 1}}
    elif tipo.lower() == 'armadura nivel 2':
        precio_arm_dos = 40
        return {'armadura nivel 2': {'precio': precio_arm_dos, 'venta': precio_arm_dos * 0.5, 'destreza': 3, 'proteccion': True, 'cantidad': 1}}
    elif tipo.lower() == 'armadura nivel 3':
        precio_arm_tres = 50
        return {'armadura nivel 3': {'precio': precio_arm_tres, 'venta': precio_arm_tres * 0.5, 'destreza': 4, 'proteccion': True, 'cantidad': 1}}
