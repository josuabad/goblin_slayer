def arma(tipo):
    if tipo.lower() == 'espada':
        ...
        return {'espada magica': {'daño': 6, 'precio': precio_espada_magica, 'venta': precio_espada_magica * 0.5,
                                  'manos': 1, 'arma': True, 'cantidad': 0}}
    elif tipo.lower() == 'Hacha dos manos':
        precio_hacha = 30
        return {'hacha dos manos': {'daño': 12, 'precio': precio_hacha, 'venta': precio_hacha * 0.5, 'manos': 2,
                                    'arma': True, 'cantidad': 0}}
...
def proteccion(tipo):
    if tipo.lower() == 'escudo':
        ...
        precio_arm_uno = 30
        return {'armadura nivel 1': {'precio': precio_arm_uno, 'venta': precio_arm_uno * 0.5, 'destreza': 2,
                                     'protección': True, 'cantidad': 0}}
    elif tipo.lower() == 'armadura nivel 2':
        precio_arm_dos = 40
        return {'armadura nivel 2': {'precio': precio_arm_dos, 'venta': precio_arm_dos * 0.5, 'destreza': 3,
                                     'protección': True, 'cantidad': 0}}
    elif tipo.lower() == 'armadura nivel 3':
        precio_arm_tres = 50
        return {'armadura nivel 3': {'precio': precio_arm_tres, 'venta': precio_arm_tres * 0.5, 'destreza': 4,
                                     'protección': True, 'cantidad': 0}}
