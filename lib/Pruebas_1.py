...
bolsillo = {'espada goblin': {'daño': 6, 'precio': None, 'venta': 5, 'manos': 1, 'arma': True, 'cantidad': 3},
            'escudo goblin': {'precio': None, 'venta': 5, 'destreza': 1, 'protección': True, 'cantidad': 1}, 'monedas': 1000}
puntos = 1
inventario = {'espada': {'daño': 8, 'precio': 10, 'venta': 5, 'manos': 1, 'arma': True, 'cantidad': 2,
                         'escudo': {'precio': None, 'venta': 5, 'destreza': 1, 'protección': True, 'cantidad': 1},
                         'pociones': 6}}
fun_tienda(inventario, bolsillo, personaje_habilidades, puntos)
