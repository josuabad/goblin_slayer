...
def habilidades(dict_habilidades: dict, puntos: int):
    # Explicación
    # En base a las habilidades del personaje y los puntos de habilidades que tenga
    # La función se encarga de repartir los puntos que quiera, siempre y cuando los tenga disponibles
    # Desarrollo:
    if puntos == 0:
